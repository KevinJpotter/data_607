...
CREATE UNIQUE INDEX `rating_UNIQUE` ON `survey`.`ratings` (`rating` ASC) VISIBLE;

CREATE INDEX `friend_id` ON `survey`.`ratings` (`friend_id` ASC) VISIBLE;

CREATE INDEX `movie_id` ON `survey`.`ratings` (`movie_id` ASC) VISIBLE;
